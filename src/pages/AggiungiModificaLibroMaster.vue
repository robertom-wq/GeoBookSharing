...
/* scheda del Libro con larghezza dinamica */
.scheda_libro {
...
/* disposizione verticale elementi caricamento copertina */
...
/* dimensioni fisse immagine anteprima */
.copertina_img {
...
@media (max-width: 768px) {
    ...
    /* azzeramento padding per recuperare spazio */
