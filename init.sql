...
\restrict u8SziK41VpWZAJfK0oi9TNQYbdbztXRV2H3XbhDWvnVkpGnfQ54b6q5bSnXYMpq
...
ALTER TABLE IF EXISTS ONLY public.utente_valutazioni DROP CONSTRAINT IF EXISTS utente_valutazioni_recensore_id_fkey;
ALTER TABLE IF EXISTS ONLY public.utente_valutazioni DROP CONSTRAINT IF EXISTS utente_valutazioni_recensito_id_fkey;
ALTER TABLE IF EXISTS ONLY public.utente_valutazioni DROP CONSTRAINT IF EXISTS utente_valutazioni_condivisione_id_fkey;
ALTER TABLE IF EXISTS ONLY public.scaffali DROP CONSTRAINT IF EXISTS scaffali_proprietario_id_fkey;
ALTER TABLE IF EXISTS ONLY public.libri DROP CONSTRAINT IF EXISTS libri_tipo_condivisione_id_fkey;
ALTER TABLE IF EXISTS ONLY public.libri DROP CONSTRAINT IF EXISTS libri_scaffale_id_fkey;
ALTER TABLE IF EXISTS ONLY public.libri DROP CONSTRAINT IF EXISTS libri_proprietario_id_fkey;
ALTER TABLE IF EXISTS ONLY public.libri DROP CONSTRAINT IF EXISTS libri_master_id_fkey;
ALTER TABLE IF EXISTS ONLY public.libri_master DROP CONSTRAINT IF EXISTS libri_master_genere_id_fkey;
ALTER TABLE IF EXISTS ONLY public.libri DROP CONSTRAINT IF EXISTS libri_genere_id_fkey;
ALTER TABLE IF EXISTS ONLY public.condivisioni DROP CONSTRAINT IF EXISTS condivisioni_tipo_condivisione_id_fkey;
ALTER TABLE IF EXISTS ONLY public.condivisioni DROP CONSTRAINT IF EXISTS condivisioni_richiedente_id_fkey;
ALTER TABLE IF EXISTS ONLY public.condivisioni DROP CONSTRAINT IF EXISTS condivisioni_proprietario_id_fkey;
ALTER TABLE IF EXISTS ONLY public.condivisioni DROP CONSTRAINT IF EXISTS condivisioni_libro_id_fkey;
DROP INDEX IF EXISTS public.utente_valutazioni_recensore_id_idx;
DROP INDEX IF EXISTS public.utente_valutazioni_recensito_id_idx;
DROP INDEX IF EXISTS public.utente_valutazioni_condivisione_id_recensore_id_recensito_i_key;
DROP INDEX IF EXISTS public.storico_utente_valutazioni_recensore_username_idx;
DROP INDEX IF EXISTS public.storico_utente_valutazioni_recensito_username_idx;
DROP INDEX IF EXISTS public.storico_eliminazioni_esecutore_username_idx;
DROP INDEX IF EXISTS public.storico_eliminazioni_azione_target_nome_idx;
DROP INDEX IF EXISTS public.storico_eliminazioni_azione_idx;
DROP INDEX IF EXISTS public.libri_titolo_idx;
DROP INDEX IF EXISTS public.libri_master_titolo_idx;
DROP INDEX IF EXISTS public.libri_master_titolo_autore_anno_key;
DROP INDEX IF EXISTS public.libri_master_isbn_key;
DROP INDEX IF EXISTS public.libri_master_isbn_idx;
DROP INDEX IF EXISTS public.libri_master_genere_id_idx;
DROP INDEX IF EXISTS public.libri_master_autore_idx;
DROP INDEX IF EXISTS public.libri_autore_idx;
DROP INDEX IF EXISTS public.idx_utenti_username;
DROP INDEX IF EXISTS public.idx_utenti_ruolo;
DROP INDEX IF EXISTS public.idx_utenti_richiesta_eliminazione;
DROP INDEX IF EXISTS public.idx_utenti_email;
DROP INDEX IF EXISTS public.idx_utenti_bannato;
DROP INDEX IF EXISTS public.idx_tipo_condivisione_dettagli;
DROP INDEX IF EXISTS public.idx_scaffali_proprietario_id_nome;
DROP INDEX IF EXISTS public.idx_scaffali_posizione;
DROP INDEX IF EXISTS public.idx_libri_scaffale;
DROP INDEX IF EXISTS public.idx_libri_prorprietario;
DROP INDEX IF EXISTS public.idx_libri_filtri;
DROP INDEX IF EXISTS public.idx_libri_disponibili;
DROP INDEX IF EXISTS public.idx_genere_dettagli;
DROP INDEX IF EXISTS public.idx_condivisioni_tipocondivisione;
DROP INDEX IF EXISTS public.idx_condivisioni_richiedente;
DROP INDEX IF EXISTS public.idx_condivisioni_proprietario;
DROP INDEX IF EXISTS public.idx_condivisioni_date;
DROP INDEX IF EXISTS public.idx_condivisioni_confermato;
DROP INDEX IF EXISTS public.idx_condivisioni_completato;
ALTER TABLE IF EXISTS ONLY public.utenti DROP CONSTRAINT IF EXISTS utenti_pkey;
ALTER TABLE IF EXISTS ONLY public.utente_valutazioni DROP CONSTRAINT IF EXISTS utente_valutazioni_pkey;
ALTER TABLE IF EXISTS ONLY public.tipi_condivisione DROP CONSTRAINT IF EXISTS tipi_condivisione_pkey;
ALTER TABLE IF EXISTS ONLY public.storico_utente_valutazioni DROP CONSTRAINT IF EXISTS storico_utente_valutazioni_pkey;
ALTER TABLE IF EXISTS ONLY public.storico_eliminazioni DROP CONSTRAINT IF EXISTS storico_eliminazioni_pkey;
ALTER TABLE IF EXISTS ONLY public.scaffali DROP CONSTRAINT IF EXISTS scaffali_pkey;
ALTER TABLE IF EXISTS ONLY public.libri DROP CONSTRAINT IF EXISTS libri_pkey;
ALTER TABLE IF EXISTS ONLY public.libri_master DROP CONSTRAINT IF EXISTS libri_master_pkey;
ALTER TABLE IF EXISTS ONLY public.generi DROP CONSTRAINT IF EXISTS generi_pkey;
ALTER TABLE IF EXISTS ONLY public.condivisioni DROP CONSTRAINT IF EXISTS condivisioni_pkey;
ALTER TABLE IF EXISTS ONLY public._prisma_migrations DROP CONSTRAINT IF EXISTS _prisma_migrations_pkey;
ALTER TABLE IF EXISTS public.utenti ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.utente_valutazioni ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.tipi_condivisione ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.storico_utente_valutazioni ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.storico_eliminazioni ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.scaffali ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.libri_master ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.libri ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.generi ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.condivisioni ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS public.utenti_id_seq;
DROP TABLE IF EXISTS public.utenti;
DROP SEQUENCE IF EXISTS public.utente_valutazioni_id_seq;
DROP TABLE IF EXISTS public.utente_valutazioni;
DROP SEQUENCE IF EXISTS public.tipi_condivisione_id_seq;
DROP TABLE IF EXISTS public.tipi_condivisione;
DROP SEQUENCE IF EXISTS public.storico_utente_valutazioni_id_seq;
DROP TABLE IF EXISTS public.storico_utente_valutazioni;
DROP SEQUENCE IF EXISTS public.storico_eliminazioni_id_seq;
DROP TABLE IF EXISTS public.storico_eliminazioni;
DROP SEQUENCE IF EXISTS public.scaffali_id_seq;
DROP TABLE IF EXISTS public.scaffali;
DROP SEQUENCE IF EXISTS public.libri_master_id_seq;
DROP TABLE IF EXISTS public.libri_master;
DROP SEQUENCE IF EXISTS public.libri_id_seq;
DROP TABLE IF EXISTS public.libri;
DROP SEQUENCE IF EXISTS public.generi_id_seq;
DROP TABLE IF EXISTS public.generi;
DROP SEQUENCE IF EXISTS public.condivisioni_id_seq;
DROP TABLE IF EXISTS public.condivisioni;
DROP TABLE IF EXISTS public._prisma_migrations;
DROP TYPE IF EXISTS public."TipiAzione";
...
33	61	1	33	1	2026-02-25	2026-03-18		f	f	2026-02-26 10:28:39.152	\N	2026-02-26 10:28:39.152
\.
...
61	Programmare con Python. Guida completa	Marco Buttu	2014	uploads/copertine/1768234548003-984670564-main.jpg	uploads/copertine/1768234548003-984670564-thumb.jpg	Descrizione..	6	999	1	27	t	2026-01-01 15:55:37.838	2026-02-26 10:28:22.338	41	33	Non definito
...
SELECT pg_catalog.setval('public.condivisioni_id_seq', 33, true);
...
\unrestrict u8SziK41VpWZAJfK0oi9TNQYbdbztXRV2H3XbhDWvnVkpGnfQ54b6q5bSnXYMpq
