...
.schermata_iniziale {
    ...
    padding: 2vw 0; /* imposto padding fluido basato sulla larghezza schermo */
...
.schermata_iniziale h1 {
    font-size: clamp(2rem, 6vw, 3.75rem);/* font size dinamico */    
...
.testo_sottotitolo {
    font-size: clamp(1rem, 2.5vw, 1.2rem);/* font size dinamico */
...
:deep(.n-card__content) {
    color: var(--color-text-dark);
    font-size: 0.95rem; /*Dimensione font leggermente piu piccola */
